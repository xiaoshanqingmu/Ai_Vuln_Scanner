...
{/loop}
  ...
  <div class="sb_box">
    ...
    <div class="active" id="productlist">
	  ...
	  {loop $plist $vo}
        <li class='list' style='width:162px; margin-left:10.875px; margin-right:10.875px;'><a href='{url($vo['method'],array('id'=>$vo['id']))}' title='[photo:title]' target='_self' class='img'><img src='{$PhotoImgPath}thumb_{$vo['picture']}' alt='[photo:title]' title='[photo:title]' width='160' height='130' /></a>
          <h3><a href='{url($vo['method'],array('id'=>$vo['id']))}' title='[photo:title]' target='_self'>[photo:title $len=12]</a></h3>
        </li>
       {/loop}
      </ul>
    </div>
