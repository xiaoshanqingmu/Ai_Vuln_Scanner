       ...
       <div class="block box">
          ...
          <ul class="bock-listp yx-u">
              {hot:{table=(photo) field=(id,title,picture,method) order=(hits desc,id desc) where=(ispass='1') limit=(4)}}
               <li><a class="box" target="_blank"  title="[hot:title]" href="{url($hot['method'],array('id'=>$hot['id']))}" ><img  src="__ROOT__/upload/photos/thumb_[hot:picture]" alt="[hot:title]" width="120" height="91"></a><h2 style="color:[hot:color]">[hot:title]</h2></li>
              {/hot}
          </ul>
       </div>
       ...
       <div class="block box">
          ...
          <ul class="bock-listp yx-u">
             {recmd:{table=(photo) field=(id,title,picture,method) order=(recmd desc,id desc) where=(ispass='1') limit=(4)}}
               <li><a class="box" target="_blank" title="[recmd:title]" href="{url($recmd['method'],array('id'=>$recmd['id']))}" ><img  src="__ROOT__/upload/photos/thumb_[recmd:picture]" alt="[recmd:title]" width="120" height="91"></a><h2 style="color:[recmd:color]">[recmd:title]</h2></li>
             {/recmd}
          </ul>
       </div>
    </div>