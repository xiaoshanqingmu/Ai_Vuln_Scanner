...
<div class="list_head_m">
        ...
        <tr>         
		  ...
		  <td align="center"><a href="{url("$app/index/index")}" target="_blank">{$config['APP_NAME']}</a></td>
         ...
         <!-- {if $app==DEFAULT_APP}
			  | <font color="green">已为默认</font>
			  {else}
			  | <a href="{url('index/setdefault', array('app'=>$app))}" target="_self"><font color="red">设为默认</font></a>
			  {/if} -->
