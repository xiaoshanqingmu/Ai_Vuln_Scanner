...
<div class="list_head_m">        
           <div class="list_head_ml">当前位置：【拓展列表】</div>
          ...
          <?php 
                 if(!empty($list)){
                      foreach($list as $vo){
                          ...
                          $cont.='<td  width="170"><a href="'.url('extendfield/fieldlist',array('id'=>$vo['id'])).'" class="edt">字段管理</a><a href="'.url('extendfield/tableedit',array('id'=>$vo['id'])).'" class="edt">编辑</a>';
