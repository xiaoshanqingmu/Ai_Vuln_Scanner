	...
	$("#info").skygqCheckAjaxForm({
		items			: items_array
          ...
          <tr>
            ...
            <td align="left" class="inputhelp">默认为模板路径下{$md}文件中index.html</td>
          </tr>           
          <tr>
          ...
          <tr>
            ...
            <td align="left" class="inputhelp">可以<a href="__APP__/extendfield/tableadd.html">在这里</a>拓展字段</td>
          </tr>            
          <tr>
            <td width="200">&nbsp;</td>
